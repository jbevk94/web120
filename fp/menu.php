...
<p>Slices of Granny Smith Apples dusted with Cinnamon, rolled into dough and finished with a glaze of honey and lemon. Our bestselling sweet creation.</p></div>
  ...
  <div class="grid-item"><img src="images/cherry.jpg" alt="placeholder" ><h3>Cherry White Chocolate</h3><p>Tart Cherries dotted with White chocolate chips.</p></div>
  <div class="grid-item"><img src="images/coffee.jpg" alt="placeholder" ><h3>Coffee Cinnamon Roll</h3><p>A delicious combination of actual Ground Coffee, Cocoa, and Cinnamon.</p></div>
  <div class="grid-item"><img src="images/hazelnut.jpg" alt="placeholder" ><h3>Chocolate Cream Hazelnut Roll</h3><p>Housemade hazelnut chocolate with actual bits of Hazelnut.</p></div>
  <div class="grid-item"><img src="images/marzipan.jpg" alt="placeholder" ><h3>Marzipan Roll</h3><p>Housemade Almond paste layered into a buttery dough.</p></div>
  <div class="grid-item"><img src="images/moscow.jpg" alt="placeholder" ><h3>Moscow Roll</h3><p>Cream of Wheat and Bavarian cream blended together, providing a light and fluffy vanilla taste</p></div>
  
  <div class="grid-item"><img src="images/rhubarb.jpg" alt="placeholder" >
<h3>Fresh Rhubarb Piroshky</h3>
<p>Slices of Rhubarb with Bavarian cream, this pastry is equally sweet and tart.</p>
</div>
